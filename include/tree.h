...
struct _tree_node_base
{
    ...
    static base_ptr
    _max_left(base_ptr _x) noexcept
    {
    ...
    _max_left(const_base_ptr _x) noexcept
    {
        while (_x->_left != nullptr)
            _x = _x->_left;
        return _x;
    ...
    static base_ptr
    _max_right(base_ptr _x) noexcept
    {
    ...
    static const_base_ptr
    _max_right(const_base_ptr _x) noexcept
    {
        while (_x->_right != nullptr)
            _x = _x->_right;
        return _x;
    ...
    static const_base_ptr
    _increment(const_base_ptr _x)
    {
        return _increment(const_cast<base_ptr>(_x));
    }

    static base_ptr
    _decrement(base_ptr _x)
    {
        if (_x->_left)
        {
            _x = _x->_left;
